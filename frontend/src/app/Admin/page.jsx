    ...
    if (!currentUser) {
        return (
            <div className="w-full min-h-screen flex flex-col md:flex-row items-center justify-center bg-gradient-to-br from-blue-100 to-indigo-200 px-4 py-8 md:px-8 md:py-0">
                ...
                <div className="w-full md:w-1/2 flex flex-col items-center justify-center text-center py-8 md:py-10 order-2 md:order-1">
                    ...
                    >
                        <Link href="/Admin/Sign-in" className="w-full px-6 py-3 md:px-8 md:py-4 bg-indigo-600 text-white rounded-lg text-lg md:text-xl font-semibold hover:bg-indigo-700 transition-colors duration-200 shadow text-center">
                            Sign In
                        </Link>
                        <Link href="/Admin/Sign-up" className="w-full px-6 py-3 md:px-8 md:py-4 border-2 border-indigo-600 text-indigo-700 rounded-lg text-lg md:text-xl font-semibold hover:bg-indigo-50 transition-colors duration-200 shadow text-center">
                            Sign Up
                        </Link>
                    </motion.div>
                </div>
        ...
        >
          <SwiperSlide className="h-full flex items-center justify-center">
            <Image src={signInImage} alt='slide_image' width={1200} height={800} className="object-cover w-full h-full rounded-2xl md:rounded-3xl shadow-lg border border-gray-200" />
          </SwiperSlide>
          <SwiperSlide className="h-full flex items-center justify-center">
            <Image src={slide_image_2} alt='slide_image' width={1200} height={800} className="object-cover w-full h-full rounded-2xl md:rounded-3xl shadow-lg border border-gray-200" />
          </SwiperSlide>
          <SwiperSlide className="h-full flex items-center justify-center">
            <Image src={slide_image_3} alt='slide_image' width={1200} height={800} className="object-cover w-full h-full rounded-2xl md:rounded-3xl shadow-lg border border-gray-200" />
          </SwiperSlide>
          <SwiperSlide className="h-full flex items-center justify-center">
            <Image src={slide_image_4} alt='slide_image' width={1200} height={800} className="object-cover w-full h-full rounded-2xl md:rounded-3xl shadow-lg border border-gray-200" />
          </SwiperSlide>
          <SwiperSlide className="h-full flex items-center justify-center">
            <Image src={slide_image_5} alt='slide_image' width={1200} height={800} className="object-cover w-full h-full rounded-2xl md:rounded-3xl shadow-lg border border-gray-200" />
          </SwiperSlide>
        </Swiper>
                </motion.div>
            </div>
