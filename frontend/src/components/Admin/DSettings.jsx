...
export default function DSettings() {
          ...
          <div className={CARD}>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                <button
                  type="button"
                  className="bg-[#3B50DF] text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-colors"
                >
                  Create Backup
                </button>
                <button
  ...
  if (loading) return <div className="p-10 text-center text-lg">Loading settings...</div>;
              ...
              <li key={item.id}>
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-2 rounded-md transition-colors ${
                    activeSection === item.id ? SIDEBAR_ACTIVE : SIDEBAR_TEXT + ' hover:bg-[#4F5BD5] hover:text-white'
                  }`}
                >
