...
import AnimatedCard from "./AnimatedCard"; // Import the animation component
...
export default function RentCard({
  ...
  duration = 1000,
  delay = 50,
}: RentCardProps & { duration?: number; delay?: number }) {
  ...
  return (
    <AnimatedCard 
      ...
      duration={duration}
      delay={delay}
      className="w-full sm:w-[48%] md:w-[48%] lg:w-[48%] xl:w-[48%] 2xl:w-[48%] min-w-0 flex-shrink-0"
    >
      <div
        key={listing._id}
        className="group w-full bg-white border border-gray-100 rounded-2xl shadow-lg dark:bg-gray-900 dark:border-gray-700 overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 hover:border-blue-200 hover:bg-gradient-to-br hover:from-white hover:to-blue-50/20 backdrop-blur-sm"
      >
