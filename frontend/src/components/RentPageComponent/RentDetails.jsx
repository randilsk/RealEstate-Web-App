...
export default function RentDetail({ listing, allListings, loading, showAllPhotos, setShowAllPhotos }) {
  ...
  return (
    <div className="w-full md:w-11/12 lg:w-4/5 xl:w-3/4 2xl:w-4/5 max-w-7xl bg-white shadow-2xl overflow-hidden rounded-3xl border border-gray-100">
      <div className="pt-8 px-6 md:px-10 bg-gradient-to-r from-green-50 to-emerald-50">
        <RentDetailNavbar />
      </div>

      {/* Image Gallery with Modern Layout */}
      <div className="relative px-6 md:px-10 py-6 bg-gradient-to-b from-green-50/30 to-white">
      ...
      <div className="px-6 md:px-10 pt-6 pb-4">
        <div className="flex flex-wrap items-center gap-3 mb-4">
          ...
          <span className="bg-gradient-to-r from-green-500 to-emerald-500 text-white text-sm font-semibold px-4 py-2 rounded-full shadow-lg">
      ...
      {/* Modern Rental Information Card */}
      <div className="mx-6 md:mx-10 mt-6 mb-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 shadow-lg border border-green-100">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-800">Rental Information</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-white rounded-xl p-4 shadow-sm">
            <div className="text-sm text-gray-600">Monthly Rent</div>
            <div className="text-xl font-bold text-green-600">Rs.{Number(rentPrice).toLocaleString()}</div>
          </div>
          {listing.securityDeposit && (
            <div className="bg-white rounded-xl p-4 shadow-sm">
              <div className="text-sm text-gray-600">Security Deposit</div>
              <div className="text-lg font-semibold text-gray-800">Rs.{Number(listing.securityDeposit).toLocaleString()}</div>
            </div>
          )}
          {listing.leaseTerms && (
            <div className="bg-white rounded-xl p-4 shadow-sm">
              <div className="text-sm text-gray-600">Lease Terms</div>
              <div className="text-lg font-semibold text-gray-800">{listing.leaseTerms}</div>
            </div>
          )}
          {listing.availableFrom && (
            <div className="bg-white rounded-xl p-4 shadow-sm">
              <div className="text-sm text-gray-600">Available From</div>
              <div className="text-lg font-semibold text-gray-800">{new Date(listing.availableFrom).toLocaleDateString()}</div>
            </div>
          )}
          {listing.furnished && (
            <div className="bg-white rounded-xl p-4 shadow-sm">
              <div className="text-sm text-gray-600">Furnished</div>
              <div className="text-lg font-semibold text-gray-800">{listing.furnished}</div>
            </div>
          )}
          {listing.utilitiesIncluded && (
            <div className="bg-white rounded-xl p-4 shadow-sm">
              <div className="text-sm text-gray-600">Utilities Included</div>
              <div className="text-lg font-semibold text-gray-800">{listing.utilitiesIncluded}</div>
            </div>
          )}
          {listing.petPolicy && (
            <div className="bg-white rounded-xl p-4 shadow-sm">
              <div className="text-sm text-gray-600">Pet Policy</div>
              <div className="text-lg font-semibold text-gray-800">{listing.petPolicy}</div>
            </div>
          )}
        </div>
      </div>
      ...
      {listing.amenities && listing.amenities.length > 0 && (
        <div className="mx-6 md:mx-10 mb-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 shadow-lg border border-purple-100">
          <div className="flex items-center gap-3 mb-4">
          ...
          <div className="flex flex-wrap gap-3">
            {listing.amenities.map((amenity, index) => (
              <span key={index} className="bg-white text-purple-700 px-4 py-2 rounded-xl text-sm font-medium shadow-sm border border-purple-100 hover:shadow-md transition-shadow duration-200">
                {amenity}
              </span>
            ))}
          </div>
      ...
      <div className="mx-6 md:mx-10 mb-6 bg-gradient-to-br from-indigo-50 to-blue-50 rounded-2xl p-6 shadow-lg border border-indigo-100">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-800">Landlord's Contact Information</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {listing.username && (
            <div className="bg-white rounded-xl p-4 shadow-sm">
              <div className="text-sm text-gray-600">Landlord Name</div>
      ...
      <div className="bg-gradient-to-r from-gray-50 to-slate-100 px-6 md:px-10 py-6 mt-4 border-t border-gray-200">
        <div className="flex flex-col md:flex-row md:justify-between items-center gap-4 mb-4">
          <div className="flex flex-wrap gap-4 justify-center md:justify-start text-sm">
            <Link href="/" className="text-gray-600 hover:text-green-600 transition-colors duration-200 font-medium">
              Home
            </Link>
            <span className="text-gray-600 hover:text-green-600 transition-colors duration-200 cursor-pointer font-medium">Help</span>
            <span className="text-gray-600 hover:text-green-600 transition-colors duration-200 cursor-pointer font-medium">About Us</span>
            <Link href="/policies/privacy_policy" className="text-gray-600 hover:text-green-600 transition-colors duration-200 font-medium">
              Privacy Policy
            </Link>
            <span className="text-gray-600 hover:text-green-600 transition-colors duration-200 cursor-pointer font-medium">Mobile App</span>
            <span className="text-gray-600 hover:text-green-600 transition-colors duration-200 cursor-pointer font-medium">Advertise</span>
            <span className="text-gray-600 hover:text-green-600 transition-colors duration-200 cursor-pointer font-medium">Cookies</span>
          </div>
