...
function AddRentingAddress() {
  ...
  const handleContinue = () => {
    ...
    router.push(
      `/rent_listing/rent_location_confirmation?address=${encodeURIComponent(
        address
          ...
          <div className="flex flex-col w-full h-full md:flex-row gap-0 items-center px-3 sm:px-5 py-3">
            ...
            <div className="w-full md:w-2/5 px-4 sm:px-7 md:px-10 py-6 md:py-10">
              <div className="text-main-blue text-lg sm:text-xl md:text-[1.3rem] font-poppins">
                Rent Your Property Directly - No Agent Needed!
              </div>
              ...
              Our smart listing tool will guide you through adding rental details, setting your monthly price, uploading photos, and showcasing your place on the map—making it easy to connect with the right tenants in just a few steps.
              </div>
            </div>
            {/* Image right column */}
            <div className="hidden md:flex w-full md:flex-1 relative items-center justify-center py-6 md:py-10">
              <div className="relative w-full max-w-[600px] aspect-[4/3]">
                <Image
                  src="/images/rent-listing-image/rent-listing.png"
...
export default AddRentingAddress;
